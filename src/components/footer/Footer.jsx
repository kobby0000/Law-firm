        ...
        <div className="footer_wrapper container">
          <div className="top">
            ...
            <div className="middle">
              <ul>
                <li>Menu</li>
                <li><a className="footer_menu" href="/the-firm">Home</a></li>
                <li><a className="footer_menu" href="/the-firm">The Firm</a></li>
                <li><a className="footer_menu" href="/personal">Project & Project Financing</a></li>
                <li><a className="footer_menu" href="/business">Busuness Support & Notary Services</a></li>
                <li><a className="footer_menu" href="/faq">Real Estate & Construction</a></li>
